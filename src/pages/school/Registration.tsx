...
export default function Registration() {
    ...
    const [formData, setFormData] = useState({
        currentTerm: 'ترم تابستان ۱۴۰۵',
        currentClass: 'رده سنی ۱۴ و ۱۵ سال'
    });
    ...
    useEffect(() => {
        if (user) {
            setFormData({
                currentTerm: user.currentTerm || 'ترم تابستان ۱۴۰۵',
                currentClass: user.currentClass || 'رده سنی ۱۴ و ۱۵ سال'
            });
        }
    }, [user]);
