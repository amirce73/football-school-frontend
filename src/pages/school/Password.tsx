        ...
        <div id="view-password" className="view-section fade-in">
            ...
            <div className="card">
                <div className="form-grid password-grid">
                    <div className="input-group"><label>رمز عبور فعلی <span className="text-danger">*</span></label><input type="password" name="currentPassword" value={formData.currentPassword} onChange={handleChange} /></div>
